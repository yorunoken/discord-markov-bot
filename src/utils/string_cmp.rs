// All of the following code was copy-pasting from https://github.com/MaxOhn/Bathbot/blob/main/bathbot-util/src/string_cmp.rs
// Credits to original programmer.
